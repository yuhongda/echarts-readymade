...
describe('testing <Scatter /> chart', () => {
  it('<Scatter /> chart works fine', async () => {
    const data = [
      {
  ...
  it('<Scatter /> chart return null if data is null', async () => {
    const dimension: Field[] = [
      {
        fieldKey: 'd1',
        fieldName: '日期'
  ...
  it('use color from setOption()', async () => {
    const data = [
      {
        v6: 0.8141021277904137,
        d1: '2020-12-31',
    ...
    expect(instance).toBeDefined()
    expect(instance.getEchartsInstance()).toBeDefined()
    const option = instance.getEchartsInstance().getOption()
    expect(option.color).toEqual(['#ccc'])
  })

  it('use color from echartsOptions', async () => {
    const data = [
      {
        v6: 0.8141021277904137,
        d1: '2020-12-31',
